...
import { getNumbersData } from '@/static'
...
const ProjectPage: NextPage = () => {
  ...
  return (
    <>
      ...
      <Alert sx={{ my: 6, mx: 3 }} severity="info">
        Questa pagina è attualmente in aggiornamento. Torna a visitarci, la pagina aggiornata sarà
        presto online.
      </Alert>
    </>
  )
