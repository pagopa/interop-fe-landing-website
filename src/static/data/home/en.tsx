...
const hero: HeroProps = {
  ...
  ctaPrimary: {
    ...
    onClick: () => {
      window.open(INTEROP_ONBOARDING_GUIDE_URL, '_blank')
    },
  },
  ctaSecondary: {
    label: 'Accedi',
    title: 'Accedi',
    onClick: () => {
      window.open(INTEROP_UI_URL, '_blank')
    },
  },
}
/* ************************************** */
...
const infoblocks = [
  {
    ...
    ctaSecondary: {
      ...
      onClick: () => {
        window.open(INTEROP_INTRO_GUIDE_URL, '_blank')
      },
    },
  },
  {
    ...
    ctaSecondary: {
      ...
      onClick: () => {
        window.open(INTEROP_E_SERVICE_GUIDE_URL, '_blank')
      },
    },
  },
  {
    ...
    ctaSecondary: {
      ...
      onClick: () => {
        window.open(INTEROP_DPO_FAQ_URL, '_blank')
      },
    },
  },
]
